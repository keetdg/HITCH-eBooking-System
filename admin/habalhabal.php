  ...
  <div class="sidebar">
    ...
    <div class="logo"><img src="images/logoicon.png"></div> 
      ...
      <ul class="nav-links" style="margin-left: 12px;">
        ...
        <li>
          <a href="habalhabal.php" class="active">
   ...
   <div class="con">          
          ...
          <thead style="color: black">
            <tr>
                ...
                <th scope="col" style="text-align: center"><b>Motor Brand</b></th>
                <th scope="col" style="text-align: center"><b>Station Address</b></th>
                <th scope="col" style="text-align: center"><b>Route</b></th>
                ...
                while($row=$query->fetch_assoc())
                    ...
                    echo "<tr style='text-align: center'>
                        ...
                        <td>
                        <a href='#view".$row['habalid']."' class='btn btn-success btn-sm b' data-toggle='modal'><i class='uil uil-eye ii' style='color:white; font-size:15px; text-align: center'></i>View</a> |
                        <a href='#deletehabal".$row['habalid']."' class='btn btn-danger btn-sm b' data-toggle='modal'><i class='uil uil-trash-alt' style='color:white; font-size:15px; text-align: center'></i>Delete</a>

...
<title>HITCH | Booking History</title>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        ...
        <!-- Title -->
        <a href="driverpanel.php" class="h4 mb-0 text-white text-uppercase d-lg-inline-block"> HITCH | DRIVER PANEL</a>
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            ...
            <p class="text-white mt-0 mb-5" style="font-size: 15px">This is your booking history. You can see the progress you've made with your work and manage your inquiries</p>
          </div>
        </div>
      </div>
    </div>
